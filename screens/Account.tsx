    ...
    >
      <ScrollView>
          ...
          >
            <View>
              <Image
                ...
                source={require("../assets/tokyolifelogo.webp")}
              />
            </View>
            <View
              style={{
        ...
        <View>
          ...
          >
            <FontAwesome5 name="birthday-cake" size={30} color="black" />
            <Text style={{ fontSize: 17, marginLeft: 10 }}>
              Chính sách sinh nhật App member
            </Text>
          </TouchableOpacity>
          <View
            style={{
