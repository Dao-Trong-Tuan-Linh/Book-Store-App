...
export default function Cart({ navigation }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <ScrollView style={{ backgroundColor: "#f5f5f5", padding: 10 }}>
        <View
          style={{
            flexDirection: "row",
            gap: 10,
        ...
        <View style={{ gap: 10 }}>
          ...
          >
            ...
            >
              <Image
                style={{ maxHeight: 119, objectFit: "contain" }}
                source={require("../assets/tuoi-tho-du-doi.jpg")}
              />
            </View>
            <View
              style={{ flexBasis: "62%", flexDirection: "column", gap: 20 }}
            >
              <View style={{ overflow: "hidden" }}>
                <Text numberOfLines={3}>Tuổi thơ dữ dội</Text>
              </View>
              <View style={{ gap: 5 }}>
                <View
